    ...
    <div class="w">
        <div class="form">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position='top' class="demo-ruleForm">
                <div class="lable">
                    <i class="ico el-icon-user-solid"></i>
                    个人信息
                </div>
                <div class="flex">
                ...
                <div class="lable">
                    <i class="ico el-icon-picture-outline"></i>
                    *图片
                </div>
                <div class="flex">
                    <el-form-item class="">
                ...
                <div class="lable">
                <i class="ico el-icon-chat-line-round"></i>
                *基本信息
                </div>
                <el-form-item  label="车辆识别代号(VIN码)" prop="vin">
                    <el-input maxlength="17" show-word-limit placeholder="请输入17位vin码"  v-model="ruleForm.vin"></el-input>
                </el-form-item>
                ...
                <div class="flex">
                    ...
                    <el-form-item class="three" label="行驶里程" prop="mile">
                        <el-input type='number'  v-model="ruleForm.mile"></el-input>
                    ...
                    <div class="flex" style="align-items:flex-end;width:850px">
                        <el-form-item style="width:800px" label="转让价格" prop="price">
                            <el-input  v-model="ruleForm.price" style="margin-right:10px"></el-input>
                            <span class="input-text">万元</span>
                        </el-form-item>
                        <el-form-item>
                            <el-checkbox v-model="ruleForm.guohuPrice">是否包含过户费</el-checkbox>
                        </el-form-item>
                    </div>
                
                <el-form-item class="three" label="车况描述" prop="descrip">
                    <el-input type="textarea"  v-model="ruleForm.descrip"></el-input>
                </el-form-item>
                <div class="lable">
                    <i class="ico el-icon-s-comment"></i>
                    更多信息
                </div>
                <div class="flex">
                    <el-form-item class="three" label="年检到期" prop="checkYear">
                        <el-select v-model="ruleForm.checkYear" placeholder="请选择年检到期">
                            <el-option
                    ...
                    <el-form-item class="three" label="交强险到期" prop="traffic">
                        <el-select v-model="ruleForm.traffic" placeholder="请选择交强险到期">
                            <el-option
                    ...
                    <el-form-item class="three" label="商业险到期" prop="insurance">
                        <el-select v-model="ruleForm.insurance" placeholder="请选择商业险到期">
                            <el-option
                ...
                <el-form-item class="three" label="车辆配置亮点" prop="hightlights">
                    <el-input type="textarea" placeholder="" v-model="ruleForm.hightlights"></el-input>
                </el-form-item>
                <div style="color:orange">
                    *温馨提示：请勿发布多条重复信息，被判定重复的信息将不会被展示哦。
                </div>
                <el-checkbox class="agree" style="margin-top:10px" v-model="agreement">
                    我已阅读并同意遵守 
                 ...
                 <el-form-item  style="width:280px;margin:30px auto">
                    <el-button class="submit" type="danger" @click="submitForm('ruleForm')">提  交</el-button>
                </el-form-item>
            </el-form>      
        </div>
    </div>
