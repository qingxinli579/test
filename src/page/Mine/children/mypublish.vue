admin<template>
  <div>
    <y-shelf title="我的发布">
      <div slot="content">
        <div v-if="goodlist.length" v-loading="loading" element-loading-text="加载中..." style="min-height: 10vw;">
              ...
              <div class="right">
                ...
                <div style="margin-left:20px">
                  ...
                  <el-tooltip content="信息填写成功等待审核" placement="right">
                    <el-tag v-if="item.status==0" size="small" type="warning">
                      <i>
                        等待审核
                      </i>
                    </el-tag>
                  ...
                  <el-tooltip content="后台正在审核请耐心等待" placement="right">
                    <el-tag v-if="item.status==2" size="small" type="warning">
                      <i>
                        正在审核
                      </i>
                    </el-tag>
                  ...
                  <el-tooltip content="审核成功，商品已发布" placement="right">
                    <el-tag v-if="item.status==1" size="small" type="success">
                      <i>
                        审核成功
                      </i>
                    </el-tag>
                  ...
                  <el-tooltip content="点击查看失败原因" placement="right">
                    <el-tag v-if="item.status==-1" size="small" type="danger" @click="reason(item.reason)">
                      <i>
                        审核失败
                      </i>
                    </el-tag>
          ...
          >
            <el-radio-group v-model="choosere">
              <el-radio label="不想卖了" />
              <el-radio v-if="status==1" label="已卖出" />
              <el-radio label="其他" />
            </el-radio-group>
            <div v-if="choosere=='已卖出'" class="price">
              <label for="">卖出价格：</label>
              <el-input v-model="price" class="price-input" />
              <i>
                万元
              </i>
            </div>
        ...
        <div v-else v-loading="loading" style="padding:50px" element-loading-text="加载中...">
          <div class="publish-e" />
